...
/** Uma verificação de sessão por requisição, compartilhada por quem precisa saber quem está logado. */
export const usuarioLogado = cache(() => authService.usuarioAtual())
