...
// "G" nas cores oficiais do Google: única marca que aparece com cor própria em vez de
// `currentColor` — é a que as diretrizes do Google pedem para botões de login, para ficar
// reconhecível (as outras marcas deste arquivo seguem o traço mono do site).
