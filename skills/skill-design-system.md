...
* `design-system/references/tokens.md`: paleta, tipografia, espaçamento, raios, sombras, estados e o CSS dos tokens.
* `design-system/references/ux-rules.md`: hierarquia, padrões de tela, estados, acessibilidade e responsivo.
* `design-system/references/components.md`: catálogo de componentes (propósito, variantes, estados, tokens usados).
* `design-system/changelog.md`: histórico de decisões e mudanças.
